...
def load_img(path, grayscale=False, target_size=None,
    ...
    if img.shape != target_size:
        img = resize(img,target_size,mode='reflect',preserve_range=True)
    return img
...
class ImageDataGenerator16bit(object):
...
class NumpyArrayIterator16(Iterator16):
...
class DirectoryIterator16(Iterator16):
    ...
    def __init__(self, directory, image_data_generator,
        ...
        self.filenames = []
        self.classes = np.zeros((self.samples,))
        i = 0
        ...
        pool.close()
        pool.join()
        super(DirectoryIterator16, self).__init__(self.samples, batch_size, shuffle, seed)
